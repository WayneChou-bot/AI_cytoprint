...
|---|---|---|---|
| raw（標準化） | 0.087 [0.080, 0.096] | 2.42 [2.07, 2.77] | — |
| sphered（ZCA） | 0.087 [0.079, 0.096] | 3.00 [2.68, 3.36] | −0.000 [−0.009, +0.008] |
| sphered+Harmony（依 plate） | **0.095** [0.089, 0.102] | **1.63** [1.46, 1.80] | **+0.008** [−0.001, +0.017] |
...
且有微弱的正向趨勢」，不是「證明沒有代價」，更不是「證明有幫助」。單獨球化則在批次軸上明顯變差（2.42× → 3.00×）。
...
|---|---|---|---|---|---|
| A549-24h | 1,039 | 0.159 | **−0.069** [−0.160, +0.028] | **−0.098** [−0.166, +0.028] | 1.46 |
| A549-48h | 1,040 | 0.187 | +0.020 [−0.030, +0.080] | +0.011 [−0.031, +0.056] | 1.11 |
| U2OS-24h | 983 | 0.154 | −0.011 [−0.046, +0.042] | −0.012 [−0.079, +0.068] | 1.19 |
| U2OS-48h | 1,040 | 0.166 | +0.014 [−0.032, +0.103] | +0.010 [−0.036, +0.088] | 1.59 |
